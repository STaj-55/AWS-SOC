...
We will be simulating a few different scenarios, and this will be updated to add in new attack scenarios to this lab.

1. Port Scanning (Beginner simulation to develop detection and response workflows)
2. Ransomware Simulation (Deal with backup recovery, containment, deal with unuauthorized encryption on EBS volume)
3. Malware-infected EC2 Instance / C2 (Identify and block malicious IPs)
4. IAM Abuse (Way to learn about IAM and how to misuse and strengthen) 
